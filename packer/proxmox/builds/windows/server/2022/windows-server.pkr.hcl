...
locals {
  ...
  vm_name_datacenter_core    = "${var.vm_guest_os_family}-${var.vm_guest_os_name}-${var.vm_guest_os_version}-${var.vm_guest_os_edition_datacenter}"
  ...
  vm_name_standard_core      = "${var.vm_guest_os_family}-${var.vm_guest_os_name}-${var.vm_guest_os_version}-${var.vm_guest_os_edition_standard}"
...
source "proxmox-iso" "windows-server-standard-core" {
  ...
  template_name        = local.vm_name_standard_core
...
source "proxmox-iso" "windows-server-standard-dexp" {
  ...
  template_name        = local.vm_name_standard_desktop
  template_description = local.build_description
...
source "proxmox-iso" "windows-server-datacenter-core" {
  ...
  template_name        = local.vm_name_datacenter_core
  template_description = local.build_description
...
source "proxmox-iso" "windows-server-datacenter-dexp" {
  ...
  template_name        = local.vm_name_datacenter_desktop
  template_description = local.build_description
...
build {
  ...
  post-processor "manifest" {
    ...
    custom_data = {
      ...
      vm_bios               = var.vm_bios
      vm_os_type            = var.vm_guest_os_type
