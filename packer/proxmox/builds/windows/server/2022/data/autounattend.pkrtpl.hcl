   ...
   <settings pass="oobeSystem">
      <component xmlns:wcm="http://schemas.microsoft.com/WMIConfig/2002/State" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" name="Microsoft-Windows-Shell-Setup" processorArchitecture="amd64" publicKeyToken="31bf3856ad364e35" language="neutral" versionScope="nonSxS">
         ...
         <FirstLogonCommands>
            ...
            <SynchronousCommand wcm:action="add">
               <CommandLine>cmd.exe /c if exist E:\windows-virtio.ps1 (%SystemRoot%\system32\WindowsPowerShell\v1.0\powershell.exe -File E:\windows-virtio.ps1) else (%SystemRoot%\system32\WindowsPowerShell\v1.0\powershell.exe -File F:\windows-virtio.ps1)</CommandLine>
               <Order>3</Order>
               <Description>Install VirtIO Drivers</Description>
            </SynchronousCommand>
            <SynchronousCommand wcm:action="add">
               <CommandLine>cmd.exe /c if exist E:\windows-init.ps1 (%SystemRoot%\system32\WindowsPowerShell\v1.0\powershell.exe -File E:\windows-init.ps1) else (%SystemRoot%\system32\WindowsPowerShell\v1.0\powershell.exe -File F:\windows-init.ps1)</CommandLine>
               <Order>4</Order>
