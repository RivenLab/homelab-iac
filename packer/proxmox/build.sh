...
declare -A MENU_ITEMS=(
  [1]="Debian 13 (Trixie)|linux/debian/13"
  [2]="Debian 12 (Bookworm)|linux/debian/12"
  [3]="Ubuntu Server 25.04|linux/ubuntu/25-04"
  [4]="Ubuntu Server 24.04 LTS|linux/ubuntu/24-04-lts"
  [5]="Windows 11 - All|windows/desktop/11|"
  [6]="Windows 11 - Enterprise|windows/desktop/11|--only proxmox-iso.windows-desktop-ent"
  [7]="Windows 11 - Professional|windows/desktop/11|--only proxmox-iso.windows-desktop-pro"
  [8]="Windows server 2022 - ALL|windows/server/2022|"
  [9]="Windows server 2022 - Datacenter|windows/server/2022|--only proxmox-iso.windows-server-datacenter-core"
  [10]="Windows server 2022 - Standard|windows/server/2022|--only proxmox-iso.windows-server-standard-core"
